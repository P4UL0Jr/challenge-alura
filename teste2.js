...
function criptografar(stringEncriptada) {
    let matrizCodigo = [["a", "ttt"], ["e", "bbb"], ["i", "ccc"], ["o", "ppp"], ["u", "hhh"]]; // o aimes foi adicionado pois o programa identificava o i do "ai" como um uma nova letra pra encriptar. Ex: se eu colocasse "ola", ao invés de aparecer "oberlai", aparecia "oberlaimes"
...
function descriptografar(stringDescriptada) {
    let matrizCodigo = [["a", "ttt"], ["e", "bbb"], ["i", "ccc"], ["o", "ppp"], ["u", "hhh"]];
